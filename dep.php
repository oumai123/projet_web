...
<h1>TRAITEMENT COURRIER DEPART</h1>
    ...
    <form id="form1" action="create.php" method="POST">
      <div class="form-date">
        ...
        <input class="heure_bo_cr_dep" name="heure_bo_cr_dep" type="time">
      </div>
        <br>
        <div class="form-courrier">
          <div class="name-frame">Courrier</div>
          <label for="num_order_bo">num_order_bo:</label>
          <input class="num_order_bo" type="number" name="num_ordre_bo">
          ...
          <input class="délais de réalisation expéditeur" type="date" name="delais">
          <br>
          <br>
      ...
      <div class="title">
        ...
        <ul class="buttons">
          <li>
            <button type="submit" form="form1" value="Enregistrer" name="submit" >
